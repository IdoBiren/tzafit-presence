    ...
    <div style={styles.container}>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.infoBox}>
          ...
          <p style={styles.desc}>
            על מנת להגן על פרטיות החניכים והמידע בפנימייה, גישתך מוגבלת באופן זמני. מנהל המערכת צריך להקצות לך קבוצה פעילה (כגון קסיופיה, מונסון וכו') לפני שתוכל להיכנס.
          </p>
